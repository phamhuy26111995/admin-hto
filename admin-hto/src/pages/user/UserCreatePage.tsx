...
function UserCreatePage() {
    ...
    const userInfo = useSelector((state: any) => state.userSlice.userInfo)
    ...
    return (
        <React.Fragment>
            <Form layout="vertical" form={form}>
                ...
                {userInfo.role === 'ROLE_ROOT' && (
                    <Row>
                        <Col>
                            <Form.Item label={"Vai trò"}
                                       name="role"
                                       required={true}
                                       initialValue={"ROLE_EMPLOYEE"}>
                                <Select>
                                    <Select.Option value="ROLE_EMPLOYEE" key={"ROLE_EMPLOYEE"}>
                                        Nhân viên
                                    </Select.Option>
                                    <Select.Option value="ROLE_ADMIN" key={"ROLE_EMPLOYEE"}>
                                        Quản lý
                                    </Select.Option>
                                </Select>
                            </Form.Item>
